    ...
    do {
        ...
        if (iResult > 0) {
            ...
            for (int i = 0; i < (int)strlen(message); i++)
            {
                switch (message[i])
                {
                case '+': temp += "плюс "; break;
                case '-': temp += "минус "; break;
                case '*': temp += "умножить "; break;
                case '/': temp += "делить "; break;
                case '=': temp += "равно "; break;
                case '0': temp += "ноль "; break;
                ...
                default: temp += "неразборчиво "; break;
                }
            }
            answer = temp.c_str();
